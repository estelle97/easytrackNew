...
<div class="page-header text-white">
    <div class="row align-items-center">
        <div class="col-auto">
            <h2 class="page-title">
                <a href="{{route('employee.products')}}" class="mr-2">
                ...
                <div class="order-controls m-4">
                    <form class="form-inline">
                        <div class="form-group mb-3">
                            ...
                            <select id="sites" disabled class="form-select">
...
<script>
    ...
    function addProducts() {
        ...
        $.ajax({
            url: '/employee/products/store/many',
            method: 'post',
            data: {
                _token: token,
                site_id: site,
            ...
            success: function(data){
                window.location.replace("/employee/products");
            }
        })
    }
