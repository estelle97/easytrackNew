            ...
            <div class="container-xl">
                ...
                <div class="page-header text-white">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <h2 class="page-title">
                                <a href={{route('employee.user.show',Auth::user()->username)}} class="mr-2">
                ...
                <div class="row">
                    <div class="card col-lg-3 px-3 py-0"
                        ...
                        <a href="#">
                            <img class="card-img-top" src={{asset("https://picsum.photos/id/700/400")}} alt="Profile picture">
                        </a>
...
@section('scripts')
    <script>
        ...
        function attachPermissionToUser(user_id){
            ...
            $.ajax({
                url: '/employee/roles/attachPermissionToUser',
                data: {
                    _token : token,
                    user_id : user_id,
        ...
        function detachPermissionToUser(user_id, permission_id){
            ...
            $.ajax({
                url: '/employee/roles/detachPermissionToUser',
                data: {
                    _token : token,
                    user_id : user_id,
                    permission_id : permission_id,
