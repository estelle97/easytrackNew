        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto ml-auto d-print-none">
                <div class="d-flex align-items-center">
                    ...
                    <a href={{route('employee.sales.all')}} class="text-white mr-4 mb-0">
        ...
        <div class="card col-lg-3 p-3" style="max-height: 700px;">
            <div class="row">
                ...
                <div class="col-md-12 text-center mt-4">
                    ...
                    <h1 style="font-size: 2.5rem;"> {{Auth::user()->employee->site->allSales() - Auth::user()->employee->site->allPurchases()}} FCFA</h1>
