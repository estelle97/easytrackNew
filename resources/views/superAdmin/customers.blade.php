                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                <div class="input-icon">
                                    ...
                                    <select id="type-update{{$com->id}}" class="auth-input type-update form-select form-control-rounded py-2 px-5">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" min="1" id="type-update-days{{$com->id}}" placeholder="Nombre de jour à rajouter" class="auth-input form-select form-control-rounded py-2 px-5">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
