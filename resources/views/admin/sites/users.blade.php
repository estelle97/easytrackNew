                    ...
                    <div class="modal-body">
                        <div class="row mb-3 align-items-end">
                            ...
                            <div class="col-lg-9 mb-4">
                                ...
                                <input type="text"   maxlength="100" pattern="^[A-Z a-z]+[0-9]{0,3}" id="user-name-add" class="form-control"
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <select name="role" id="user-site-add" class="form-select">
                                    @foreach (Auth::user()->companies()->first()->sites()->get() as $sites)
                                        <option {{($site->id == $sites->id) ? 'selected' : ''}} value="{{$sites->id}}"> {{$sites->name}} </option>
                                    @endforeach
                                </select>
                            </div>
                             <div class="col-lg-12 mb-4">
