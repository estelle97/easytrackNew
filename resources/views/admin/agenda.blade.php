            ...
            <div class="d-flex align-items-center">
                <span class="dropdown ml-5 button-click-action">
                    <div class="dropdown-toggle" data-boundary="viewport" data-toggle="dropdown">
                        ...
                        <span class="h2 selected-site align-middle ml-2 currentSite"> {{Auth::user()->companies->first()->sites->first()->name}} </span>
                    </div>

                    <div class="dropdown-menu dropdown-menu-right mt-3">
                        @foreach (Auth::user()->companies->first()->sites as $site)
                            <a class="dropdown-item site" onclick="showTeams({{$site->id}}, '{{$site->name}}')">
                                {{$site->name}}
                            </a>
                        @endforeach
                    </div>
...
<div class="row row-deck row-cards">
    <div class="col-lg-12">
        <div class="card card-max-size p-4 teams" style="overflow-x: hidden;">
            <div class="row">
                @for ($i = 1; $i <= 7; $i++)
                        ...
                        <div class="card agenda-card">
                            <div class="card-body">
                                ...
                                <div class="avatar-list avatar-list-stacked mb-3">
                                    {{App\Team::where('site_id', Auth::user()->companies->first()->sites->first()->id)->where('day', $i)->count()}} équipe(s)
                                </div>
                                <div class="card-meta d-flex justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span> {{Auth::user()->companies->first()->sites->first()->name}} </span>
                                    </div>
                                    <span class="dropdown">
                                        <div class="dropdown-toggle" data-boundary="viewport" data-toggle="dropdown">
