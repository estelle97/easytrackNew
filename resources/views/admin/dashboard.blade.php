            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                        <div class="h1 mb-0 mr-2"> <span id="sales"> {{Auth::user()->companies->first()->totalSales()}} </span> Fcfa</div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                        <div class="h1 mb-0 mr-2"> <span id="purchases"> {{Auth::user()->companies->first()->totalPurchases()}} </span> Fcfa</div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                        <div class="h1 mb-0 mr-2"> <span id="profits"> {{Auth::user()->companies->first()->totalSales() - Auth::user()->companies->first()->totalPurchases()}} </span> Fcfa</div>
                    </div>
...
@section('scripts')
    <script>
        ...
        function getPurchases(days, text){
            $.ajax({
                url: '/admin/stats/purchases/'+days,
                method: 'get',
                success: function(data) {
