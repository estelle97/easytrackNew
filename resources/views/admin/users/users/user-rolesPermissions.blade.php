                        ...
                        <div class="modal-body bg-white">
                            <div class="row mb-3 align-items-end">
                                <div class="col-lg-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Saisissez le nom..."
                                        value="{{$role->name}}" />
                                </div>
                                <div class="col-lg-12 mb-4">
...
<div class="modal modal-blur fade" id="modal-create-role" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script>
        ...
        function addPermissionToRole(){
            ...
            var permission = $('#select-permission').text();
            if(!permissions.includes(permission_id)){
                $("#permissions-add").append("<tr id='perm"+permission_id+"'><td>"+
                                                permission+
                                            "</td>"+
                                            "<td class='text-right'>"+
                                                "<a class='mt-1' onclick='removePermissionToRole("+permission_id+")'>"+
                                                    "Supprimer"+
                                                "</a>"+
                                            "</td></tr>"
                                        );
        ...
        function attachPermissionToRole(id){
            ...
            $.ajax({
                url: '/roles/attachPermissionToRole',
                data: {
                    _token : token,
                    role_id : id,
                ...
                success:function (data) {
                    if(data == 'success'){
                        $("#permission-edit"+id).append("<tr id='perm-role-list"+id+"-"+permission_id+"'><td>"+
                                            ...
                                            "</td>"+
                                            "<td class='text-right'>"+
                                                "<a class='mt-1' onclick='detachPermissionToRole("+id+","+permission_id+")'>"+
                                                    "Supprimer"+
                                                "</a>"+
                                            "</td></tr>"
                                    )
        ...
        function detachPermissionToRole(role_id, permission_id){
            ...
            $.ajax({
                url: '/roles/detachPermissionToRole',
                data: {
                    _token : token,
                    role_id : role_id,
                    permission_id : permission_id,
