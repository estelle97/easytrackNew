    ...
    <div class="row align-items-center">
        ...
        <div class="col-auto ml-auto d-print-none">
            <div class="d-flex align-items-center">
                ...
                <a href={{route('admin.profile.edit')}} class="d-flex align-items-center text-white mr-5">
...
{{-- 
                <a href={{route('admin.profile.settings')}} class="d-flex align-items-center text-white">
