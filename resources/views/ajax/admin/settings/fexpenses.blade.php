...
<div>
    @foreach (Auth::user()->companies->first()->sites as $site)
        @foreach ($site->fexpenses as $fexp)
            <div class="col-md-6 col-xl-12" id="fexpense{{$site->id}}{{$fexp->id}}">
                <div class="card card-sm">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="mr-3 lh-sm">
                            <div class="strong">
                                <span> {{$site->name}} </span> - <span> {{$fexp->name}} </span>
                            </div>
                            <div class="text-muted"> <span> {{$fexp->amount}} </span> FCFA</div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <input type="date" min="1" max="28" id="date_payment" min="0" class="form-control">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary"
                        style="width: 100%" onclick="addExpense()">Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
