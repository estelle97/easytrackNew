                                                        ...
                                                        @foreach ($purchase->products as $prod)
                                                            <tr id="product-{{$prod->id}}">
                                                                ...
                                                                <td class="col-sm-3">
                                                                    ...
                                                                    <input type="text" class="quantity-input form-control p-0 text-center border-0" value="1" id="qty-{{$prod->id}}" data-total={{$prod->pivot->qty}} data-qty="{{$prod->pivot->qty}}" required  oninput="updateQty({{$prod->id}}, this.value)">
