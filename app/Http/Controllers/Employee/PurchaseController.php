...
class PurchaseController extends Controller
{
    ...
    {
        return view('employee.orders.purchases');
    }
    ...
    {
        return view('ajax.employee.purchase_create');
    }
    ...
    {
        return view('employee.orders.purchase_order', compact('purchase'));
    }
    ...
    public function edit(Purchase $purchase)
    {
        ...
        return response()->json([
            'products' => $products,
            'view' =>  (string)view('ajax.employee.purchase_update', compact('purchase')),
        ], 200);
    }
